...
<li><a href="javascript:void(open_popup('lista_de_voluntariado_y_pasantia.html'))"><img src="images/iconos/lista_cursos_espanol_costos.png" alt="" border="0" /> Liste für Praktikas und Freiwilligenarbeit</a></li>

<li><a href="#" onclick="Slider.slide({url: 'includes/secciones/download-des-anmeldeformulares_2.php?returnpage=voluntariat.php'}, 6); return false;"><img src="images/iconos/download_formularios.png" alt="" border="0" /> Anmeldeformulare</a></li>

<li><a href="store/TEILNAHMEBEDINGUNGEN.pdf"><img src="images/iconos/condiciones_participar.png" alt="" border="0" /> Teilnahmebedingungen</a></li>
...
<li><a href="#" onclick="Slider.slide({url: 'includes/secciones/wie-geht-es-weiter.php?returnpage=voluntariat.php&filename=Preisliste_2010_Green_Fields3.html'}, 11); return false;"><img src="images/iconos/como_seguir.png" alt="" border="0" /> Wie geht es weiter mit Voluntariaten und Freiwilligenarbeit</a></li>
